  ...
  <div class="main">
      ...
      <div v-for="item in list" :key="item" class="cart-goods-item">
        ...
        <div class="item-goods-info">
          <img
            ...
            alt="goods img"
            lazy="loading"
            src="https://p1-cdn-holiland.1900m.com/goods/cover_s/202311/29/936a1701241390b9013.jpg?x-oss-process=image/resize,m_fill,limit_0,w_80,h_80"
          />
          <div>
            <div class="name">黄油芝士啤酒风味 半熟芝士-糕点</div>
            <div class="flavor">黄油芝士啤酒风味</div>
            <div class="spec">5枚/盒</div>
            <!---->
          </div>
        </div>
        <div class="item-attr">40</div>
        <div class="item-attr">
          <span class="price"
            ><span class="base-price">¥ 40</span
            ><!----></span
          >
        </div>
        <div class="item-attr">
          <div class="base-counter">
            <span class="base-counter-minus"
              ><img
                class="base-icon"
    ...
    <div class="bottom">
      ...
      <div class="bottom-right">
        ...
        <el-button type="primary" style="margin-left: 15px; width: 100px; height: 45px; border-radius: 15px">
          <div>
